    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (odid != null && pin == null && status == null) {
                ...
                text = str.getStrname() + "@" + str.getStraddress() + "@" + str.getStrcontact() + "@" + cstm.getCstmname() + "@" + cstm.getCstmaddress() + "@" + cstm.getCstmcontact() + "@" + sts.getAcceptstatus();
                out.println(text);
            }
                ...
                if (p.equals(pin)) {
                    ...
                    for (int i = 0; i < atc.size(); i++) {
                        ...
                        if (i == 0) {
                            ...
                            historyid = DaoOrderHistory.getLastRowId();
                            System.out.println("Last History id : " + historyid);
                            DaoServicerHistory.insertOrder(sid, historyid, ord.getStrid());
                        }
                        if (historyid != 0) {
